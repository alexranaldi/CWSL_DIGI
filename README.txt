CWSL_DIGI is a program for the CWSL architecture for decoding WSJT-X digital modes and sending reports to spotting networks such as PSK Reporter and Reverse Beacon Network. CWSL_DIGI was developed by W2AXR, with testing and feedback from WZ7I and W3OA.
